            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 px-4">
              {filteredQuizzes.map((quiz) => (
                ...
                >
                  ...
                  <button
                    className="w-full px-6 py-2 bg-gradient-to-r from-[#FF9100] to-[#FF5E00] text-[#ffffff] text-lg font-semibold rounded-full shadow-lg hover:scale-105 transform transition duration-300 ease-in-out cursor-not-allowed opacity-50"
                    disabled
                  >
